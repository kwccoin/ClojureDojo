...
;   the first 2 items in coll, then applying f to that result
;   and the 3rd item, etc.
; - If coll contains no items, f must accept no arguments as
...
;   the first item in coll, then applying f to that result and the 2nd
;   item, etc.
